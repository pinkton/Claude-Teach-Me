...
.LC3:
	.string	"\nInt Debug values:\nsizeof(numbers): "
.LC4:
	.string	"sizeof(numbers[0]): "
.LC5:
	.string	"Array length: "
	.align 8
.LC6:
	.string	"Char Debug values:\nsizeof(number): "
.LC7:
	.string	"sizeof(number[0]): "
.LC8:
	.string	"Using modern loops: "
	.text
	.globl	main
	.type	main, @function
main:
.LFB1731:
	...
	mov	DWORD PTR -32[rbp], 16
	mov	DWORD PTR -28[rbp], 32
	lea	rax, .LC0[rip]
	mov	rsi, rax
...
.L4:
	...
	mov	rdi, rax
	call	_ZNSolsEPFRSoS_E@PLT
	mov	DWORD PTR -14[rbp], 134480385
	mov	WORD PTR -10[rbp], 8208
	lea	rax, .LC6[rip]
	mov	rsi, rax
	lea	rax, _ZSt4cout[rip]
	mov	rdi, rax
